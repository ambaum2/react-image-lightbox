            ...
            return _inherits(ReactImageLightbox, _Component), _createClass(ReactImageLightbox, [ {
                ...
                value: function(srcType, imageSrc, done) {
                    ...
                    inMemoryImage.onerror = function(errorEvent) {
                        _this5.props.onImageLoadError(imageSrc, srcType, errorEvent), done(errorEvent);
                ...
                key: "loadAllImages",
                value: function() {
                    var _this6 = this, props = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.props, generateLoadDoneCallback = function(srcType, imageSrc) {
                        return function(err) {
                            // Give up showing image on error
                            err || // Don't rerender if the src is not the same as when the load started
                            // or if the component has unmounted
                            _this6.props[srcType] === imageSrc && _this6.mounted && // Force rerender with the new image
                            _this6.forceUpdate();
                        };
                    };
                    // Load the images
                    this.getSrcTypes().forEach(function(srcType) {
                        ...
                        props[type] && !_this6.isImageLoaded(props[type]) && _this6.loadImage(type, props[type], generateLoadDoneCallback(type, props[type]));
                    });
                }
            }, {
                key: "requestClose",
